        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-12">
                ...
                <p class="font-size-14 font-rale text-white-50">Lorem, ipsum dolor sit amet consectetur adipisicing
                    elit. Voluptas omnis fuga ratione maiores cupiditate aliquam, odit molestias nostrum. Odio,
                    accusantium?</p>
            </div>
...
<div class="copyright text-center bg-dark text-white py-2">
    <p class="font-rale font-size-14">&copy; Copyrights 2021. Designed by <a href="#" class="color-second">Evgeny
            Polyakov</a></p>
</div>
